...
func main() {
	...
	r.GET("/stock-exchanges/:id", middleware.RequireRole("EMPLOYEE"), handlers.GetStockExchange(securitiesClient))
	...
	r.GET("/stock-exchanges/:id/hours", middleware.RequireRole("EMPLOYEE"), handlers.GetWorkingHours(securitiesClient))
