...
const file_email_proto_rawDesc = "" +
	...
	"\x1eSendPasswordResetEmailResponse2\xd3\x01\n" +
	"\fEmailService\x12\\\n" +
	"\x13SendActivationEmail\x12!.email.SendActivationEmailRequest\x1a\".email.SendActivationEmailResponse\x12e\n" +
	"\x16SendPasswordResetEmail\x12$.email.SendPasswordResetEmailRequest\x1a%.email.SendPasswordResetEmailResponseB,Z*github.com/exbanka/backend/shared/pb/emailb\x06proto3"
...
var file_email_proto_depIdxs = []int32{
	...
	3, // 3: email.EmailService.SendPasswordResetEmail:output_type -> email.SendPasswordResetEmailResponse
